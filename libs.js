var libs = {
	...
	"amd.loader": {
		"name": "amd.loader",
		"filename": "amd.loader.js",
		"version": "0.9.0",
		"description": "A Simple AMD loader Implementation, subset of Asynchronous Module Definition (AMD) API.",
		"homepage": "https://github.com/enimo/amd-loader",
		"keywords": ["amd", "cmd", "loader"],
		"maintainers": [{
			"name": "enimo",
			"web": "https://github.com/enimo",
			"mail": "enimong@gmail.com"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/enimo/amd-loader"
		}]
	},
	"angular-file-upload": {
		"name": "angular-file-upload",
		"filename": "angular-file-upload.js",
		"version": "1.3.1",
		...
		"keywords": ["angular", "upload"],
		"maintainers": [{
			"name": "danialfarid",
			"web": "https://github.com/danialfarid"
		}],
		"repositories": [{
			"type": "git",
	...
	"angular-resource": {
		...
		"repositories": [{
			"type": "git",
			"url": "https://github.com/angular/bower-angular-resource"
		}]
	},
	"angular.js": {
		"name": "angular.js",
		...
		"version": "1.1.4.0-beta.4",
		"homepage": "http://angularjs.org",
		"keywords": ["framework", "mvc", "AngularJS", "angular", "angular.js"],
		"contributors": [{
			"name": "Miško Hevery"
		}, {
			"name": "Igor Minár"
	...
	"angular-cookies": {
		...
		"repositories": [{
			"type": "git",
			"url": "https://github.com/angular/bower-angular-cookies"
		}]
	},
	"animate.css": {
		"name": "animate.css",
	...
	"backbone.babysitter": {
		...
		"filename": "backbone.babysitter.js",
		"version": "v0.0.6",
		"description": "Manage child views in a Backbone.View.",
		"homepage": "http://marionettejs.com",
		"keywords": ["backbone", "babysitter", "marionette"],
		"maintainers": [{
			"name": "marionettejs",
			"web": "http://marionettejs.com"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/marionettejs/backbone.babysitter"
		}]
	},
	"async": {
		"name": "async",
	...
	"backbone.js": {
		...
		"keywords": ["collections", "models", "controllers", "events", "popular"],
		"maintainers": [{
	...
	"behave.js": {
		...
		"homepage": "https://github.com/jakiestfu/Behave.js",
		"keywords": ["editor", "textarea"],
		"maintainers": [{
			"name": "jakiestfu",
			"web": "https://github.com/jakiestfu"
		}],
		"repositories": [{
			"type": "git",
	...
	"bluebird": {
		"name": "bluebird",
		"description": "Bluebird is a fully featured Promise library with focus on innovative features and performance.",
		"filename": "bluebird.js",
		"version": "1.2.2",
		"keywords": ["promise", "performance", "fast", "promises-aplus", "async"],
	...
	"bootstrap": {
		...
		"version": "3.3.0",
		"keywords": ["css", "less", "mobile-first", "responsive", "front-end", "framework", "web"],
	...
	"bootstrap-glyphicons": {
		...
		"filename": "css/bootstrap-glyphicons.css",
		"version": "1.0",
	...
	"bootswatch": {
		...
		"filename": "bootswatch",
		"version": "3.0.0",
		"description": "Bootswatch is a collection of free themes for Bootstrap. Check it out at bootswatch.com.",
		"homepage": "http://bootswatch.com/",
		"keywords": ["UI", "Bootstrap", "theme"],
		"maintainers": [{
			"name": "thomaspark",
			"web": "https://github.com/thomaspark"
		}],
		"repositories": [{
			"type": "git",
	...
	"bucky": {
		...
		"filename": "bucky.min.js",
		"version": "0.2.4",
		"description": "Open-source tool to measure the performance of your web app directly from your users' browsers.",
		"homepage": "http://github.hubspot.com/bucky/",
		"keywords": ["bucky", "buckyClient", "rum", "monitoring"],
		"maintainers": [{
			"name": "The Bucky team"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/HubSpot/BuckyClient.git"
		}]
	},
	"camanjs": {
		"name": "camanjs",
		...
		"keywords": ["html5", "canvas", "image", "filter", "manipulate", "pixel", "effects"],
		"maintainers": [{
			"name": "Ryan LeFevre",
	...
	"canjs": {
		...
		"keywords": ["framework", "mvc", "CanJS"],
		"contributors": [{
			"name": "Bitovi",
			"web": "http://bitovi.com/",
			"mail": "contact@bitovi.com"
		}],
		"repositories": [{
			"type": "git",
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["can.dojo.js", "can.dojo.min.js", "can.jquery.js", "can.jquery.min.js", "can.mootools.js", "can.mootools.min.js", "can.yui.js", "can.yui.min.js", "can.zepto.js", "can.zepto.min.js"]
		}]
	},
	"canvasjs": {
		"name": "canvasjs",
		...
		"version": "1.4.1",
		"description": "CanvasJS is an easy to use HTML5 & JavaScript Charting library built on Canvas element.",
		"homepage": "http://canvasjs.com/",
		"keywords": ["canvas", "charts"],
		"author": "fenopix",
	...
	"chardin.js": {
		"name": "chardin.js",
		"filename": "chardinjs.min.js",
		"version": "0.1.2",
		"description": "Simple overlay instructions for your apps.",
		"homepage": "http://heelhook.github.io/chardin.js/",
		"keywords": ["overlay", "instructions", "chardin"],
		"author": {
			"name": "Pablo Fernandez",
			"email": "heelhook@littleq.net",
			"url": "http://heelhook.github.com"
		},
		"repositories": [{
			"type": "git",
	...
	"chart.js": {
		...
		"keywords": ["Chart.js", "charts"],
		"maintainers": [{
			"name": "nnnick",
			"web": "http://www.nickdownie.com/",
			"mail": "hello@nickdownie.com"
		}],
		"repositories": [{
			"type": "git",
	...
	"cookies.js": {
		...
		"npmFileMap": [{
			"basePath": "/src/",
			"files": ["cookies.js", "cookies.min.js"]
		}]
	},
	"crossfilter": {
		"name": "crossfilter",
	...
	"cryptico": {
		...
		"keywords": ["aes", "encryption", "javascript", "rsa"],
		"maintainers": [{
			"name": "wwwtyro"
		}],
		"repositories": [{
	...
	"crypto-js": {
		...
		"keywords": ["JavaScript", "Crypto", "MD5", "SHA-1", "SHA-2", "SHA-3", "HMAC", "PBKDF2", "AES", "TripleDES", "Rabbit", "RC4"],
		"author": {
			"name": "Jeff Mott"
		},
		"repositories": [{
	...
	"cubism": {
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["cubism.v1.js", "cubism.v1.min.js"]
		}]
	},
	"d3": {
		"name": "d3",
	...
	"date.format.js": {
		"name": "Date Format",
		"filename": "date.format.js",
		"version": "1.2.3",
		"description": "Accepts a date, a mask, or a date and a mask.  Returns a formatted version of the given date.",
		"homepage": "http://blog.stevenlevithan.com/archives/date-time-format",
		"keywords": ["dateformat"],
		"maintainers": [{
			"name": "Steven Levithan",
			"web": "https://github.com/slevithan"
		}],
		"repositories": [{
			"type": "none",
	...
	"datejs": {
		...
		"keywords": ["date", "datetime", "time", "parser"],
		"maintainers": [{
	...
	"dc": {
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["dc.css", "dc.min.js", "dc.js"]
		}]
	},
	"devexpresschartjs": {
		"name": "DevExpressChartJS",
		"filename": "dx.chartjs.js",
		"version": "13.1.8",
		"description": "Simply Stunning HTML5 JavaScript Chart and Gauge Widgets",
		"homepage": "http://chartjs.devexpress.com",
		"keywords": ["chartjs", "charts", "devexpress"],
		"maintainers": [{
			"name": "DevExpress",
			"web": "https://www.devexpress.com",
			"mail": "info@devexpress.com"
		}],
		"repositories": []
	},
	"dojo": {
		...
		"keywords": ["javascript", "framework", "module", "plugins "]
	},
	"draggabilly": {
		"name": "draggabilly",
	...
	"dropzone": {
		...
		"npmFileMap": [{
			"basePath": "/downloads/",
			"files": ["css/basic.css", "css/dropzone.css", "css/stylus/basic.styl", "css/stylus/dropzone.styl", "dropzone-amd-module.js", "dropzone-amd-module.min.js", "dropzone.js", "dropzone.min.js", "images/spritemap.png", "images/spritemap@2x.png"]
		}]
	},
	"easyxdm": {
		"name": "easyXDM",
		...
		"keywords": ["cross-browser", "cross-domain", "messaging", "rpc"],
		"maintainers": [{
	...
	"echarts": {
		...
		"keywords": ["js图表", "图表库", "数据可视化"],
		"maintainers": [{
			"name": "Kener",
			"web": "http://weibo.com/kenerlinfeng",
			"mail": "kener.linfeng@gmail.com"
		}, {
			"name": "Pissang",
			"mail": "shenyi.914@gmail.com"
		}, {
			"name": "Erik",
			"mail": "errorrik@gmail.com"
		}, {
			"name": "Yangji",
			"mail": "511415343@qq.com"
		}],
		"repositories": [{
			"type": "git",
	...
	"equalize.js": {
		...
		"keywords": ["ui", "equalize", "equal", "height", "width", "layout"],
	...
	"ext-core": {
		...
		"keywords": ["framework", "toolkit", "desktop", "popular"],
		"maintainers": [{
			"name": "Sencha"
		}]
	},
	...
	"fabric.js": {
		...
		"keywords": ["canvas", "graphics", "js", "svg", "html5"],
		"maintainers": [{
			"name": "Juriy Zaytsev",
			"web": "https://github.com/kangax"
		}, {
			"name": "Stefan Kienzle",
			"web": "https://github.com/Kienz"
		}],
	...
	"fancybox": {
		...
		"keywords": ["fancybox", "jquery", "images", "image", "zoom", "zooming"],
		"maintainers": [{
	...
	"favico.js": {
		...
		"keywords": ["favico.js", "badges", "favicon"],
		"maintainers": [{
			"name": "Miroslav Magda",
			"web": "http://blog.ejci.net/"
		}],
		"repositories": [{
			"type": "git",
	...
	"floatlabels.js": {
		"name": "floatlabels.js",
		"filename": "floatlabels.min.js",
		"description": "floatlabels.js follows the famous Float Label Pattern. Built on jQuery.",
		"version": "1.0.0",
		"keywords": ["floatlabels", "label"],
		"maintainers": [{
			"name": "Oliver Hartl",
			"web": "http://ohartl.de"
		}],
		"homepage": "http://clubdesign.github.io/floatlabels.js",
	...
	"flot": {
		...
		"keywords": ["jquery", "plot", "chart", "graph", "visualization", "canvas", "graphics", "web"],
		"maintainers": [{
			"name": "David Schnur"
		}],
		"repositories": [{
	...
	"fluidbox": {
		...
		"version": "1.2.7",
		"description": "Replicating Medium's beautiful, minimalist lightbox module with jQuery. Refer to project on GitHub for further information and usage instructions.",
		...
		"keywords": ["fluidbox", "lightbox"],
		"license": "MIT",
		"ignore": ["**/.*", "node_modules", "bower_components", "test", "package.json"],
		"dependencies": {
			"jquery": ">=1.9 <2.0",
			"jquery.imagesloaded": "latest"
		}
	},
	"fontawesome": {
		"name": "fontawesome",
		...
		"keywords": ["css", "font", "icons"],
		"npmName": "font-awesome",
		"npmFileMap": [{
			"basePath": "/",
			"files": ["css/font-awesome.css", "css/font-awesome.min.css", "fonts/FontAwesome.otf", "fonts/fontawesome-webfont.eot", "fonts/fontawesome-webfont.woff", "fonts/fontawesome-webfont.ttf", "fonts/fontawesome-webfont.svg"]
		}]
	},
	"fuse.js": {
		"name": "fuse.js",
	...
	"galleriffic": {
		...
		"keywords": ["jquery", "gallery", "images"],
		"maintainers": [{
			"name": "Lorenzo Raffio",
	...
	"grindplayer": {
		...
		"keywords": ["video", "audio", "flash", "osmf", "player"],
		"maintainers": [{
			"name": "Mihail Latyshov",
			"web": "https://github.com/kutu"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/kutu/GrindPlayer.git"
		}]
	},
	"grindplayercn": {
		"name": "GrindPlayerCN",
		"filename": "GrindPlayerCN.swf",
		"version": "1.0.1",
		"description": "OSMF + Flex based flash video player, which provides most needed functionality in nowadays.(此版本为中文裁剪BUG修复版)",
		"homepage": "http://osmfhls.kutu.ru/docs/grind/",
		"keywords": ["video", "audio", "flash", "osmf", "player"],
		"maintainers": [{
			"name": "Mihail Latyshov",
		...
		"repositories": [{
			"type": "git",
			"url": "https://github.com/KentEduSoho/GrindPlayer"
		}]
	},
	"gumby": {
		"name": "gumby",
		"filename": "css/gumby.min.css",
		"version": "2.6.0",
		"description": "A Flexible, Responsive CSS Framework.",
		"homepage": "http://gumbyframework.com/",
		"keywords": ["css", "gumby", "responsive"],
		"maintainers": [{
			"name": "Adam Chambers",
			"web": "https://github.com/chambaz"
		}],
		"repositories": [{
			"type": "git",
	...
	"h5validate": {
		...
		"keywords": ["form", "html5", "form validation", "validation", "jquery"],
		"repository": {
			"type": "git",
	...
	"hammer.js": {
		...
		"keywords": ["events", "touch", "gestures"],
	...
	"handlebars.js": {
		...
		"npmFileMap": [{
			"basePath": "/dist/",
			"files": ["handlebars.amd.js", "handlebars.amd.min.js", "handlebars.js", "handlebars.min.js", "handlebars.runtime.amd.js", "handlebars.runtime.amd.min.js", "handlebars.runtime.js", "handlebars.runtime.min.js"]
		}]
	},
	"headjs": {
		"name": "headjs",
		...
		"keywords": ["loader", "polyfill", "html5", "css3", "popular"],
	...
	"highlight.js": {
		...
		"keywords": ["highlight", "highlight.js", "syntax highlighter"],
		"maintainers": [{
			"name": "Diwaker Gupta"
		}, {
			"name": "Ivan Sagalaev",
	...
	"history.js": {
		...
		"keywords": ["history", "state", "html5", "onhashchange"],
		"maintainers": [{
	...
	"impress.js": {
		...
		"keywords": ["slideshow", "slides", "css3"],
		"maintainers": [{
			"name": "Bartek Szopka",
	...
	"imageter.js": {
		"name": "imageter",
		"filename": "imageter.front.js",
		"version": "1.0.1",
		"description": "imageter front js",
		"homepage": "http://www.imageter.com/",
		"keywords": ["dsp", "imageter"],
		"maintainers": [{
			"name": "xuguanming",
			"email": "xuguangming@imageter.com",
			"web": "http://www.imageter.com/"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/imageter/frontjs"
		}]
	},
	"instantclick": {
		"name": "instantclick",
		...
		"keywords": ["ajax", "preload", "pjax", "history"],
		"maintainers": [{
			"name": "InstantClick",
	...
	"intro.js": {
		...
		"version": "0.5.0",
		"keywords": ["intro.js", "tutorial", "step-by-step guide", "introductions"],
		"maintainers": [{
			"name": "Afshin Mehrabani",
			"email": "afshin.meh@gmail.com",
			"web": "https://github.com/afshinm"
		}],
		"demos": ["http://usablica.github.com/intro.js/"],
	...
	"jmpress": {
		...
		"bugs": "https://github.com/jmpressjs/jmpress.js/issues",
		"main": "jmpress.js",
		"jam": {
			"main": "jmpress.js",
			"dependencies": {
	...
	"jquery": {
		...
		"keywords": ["jquery", "library", "ajax", "framework", "toolkit", "popular"],
		"maintainers": [{
	...
	"jquery-fullpage": {
		...
		"filename": "jquery.fullPage.js",
		"version": "2.1.8",
		"description": "A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites). It allows the creation of fullscreen scrolling websites, as well as adding some landscape sliders inside the sections of the site.",
		"homepage": "https://github.com/alvarotrigo/fullPage.js",
		"keywords": ["jQuery", "fullPage"],
		"maintainers": [{
			"name": "Alvaro Trigo",
			"web": "https://github.com/alvarotrigo/fullPage.js",
			"mail": "alvaro@alvarotrigo.com"
		}],
		"repositories": [{
			"type": "git",
	...
	"jquery-i18n": {
		...
		"keywords": ["jquery", "i18n"],
		"maintainers": [{
			"name": "Dave Perrett",
			"web": "http://www.daveperrett.com"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/recurser/jquery-i18n"
		}]
	},
	"jquery-qrcode": {
		"name": "jquery-qrcode",
	...
	"jquery-scrollup": {
		...
		"filename": "jquery.scrollUp.js",
		"version": "2.1.0",
		"description": "ScrollUp is a lightweight jQuery plugin to create a customisable “Scroll to top” feature that will work with any website, with ease.",
		"homepage": "http://markgoodyear.com/2013/01/scrollup-jquery-plugin/",
		"keywords": [],
		"maintainers": [{
			"name": "Mark Goodyear",
			"web": "http://markgoodyear.com"
		}],
		"repositories": [{
			"type": "git",
	...
	"jquery.infinitescroll.js": {
		"name": "jquery.infinitescroll.js",
		"filename": "jquery.infinitescroll.js",
		"version": "2.0.2",
	...
	"jquerymobile": {
		...
		"keywords": ["framework", "toolkit", "popular"],
		"maintainers": [{
			"name": "The jQuery Project"
		}],
		"repositories": [{
	...
	"jqueryui": {
		...
		"keywords": ["jquery", "jqueryui", "jquery-ui", "ui", "themeing", "popular"],
		"maintainers": [{
			"name": "JQuery UI Team"
		}],
		"repositories": [{
	...
	"js-signals": {
		...
		"keywords": ["event", "messaging", "popular"],
		"maintainers": [{
	...
	"justgage": {
		"name": "justGage",
		"filename": "justgage.1.0.1.min.js",
		"version": "1.0.1",
	...
	"keymaster": {
		"name": "keymaster",
		"filename": "keymaster.js",
		"description": "keymaster.js is a hotkeys library written in plain JavaScript.",
		"version": "1.6.1",
	...
	"kizzy": {
		"name": "kizzy",
		"filename": "kizzy.min.js",
		"description": "x-browser LocalStorage API with a memcached interface",
		"keywords": ["ender", "cache", "local storage", "caching", "expiration", "dom"],
		"version": "0.0.5",
		"homepage": "https://github.com/ded/kizzy",
		"maintainers": [{
			"name": "Dustin Diaz <dustin@dustindiaz.com>",
			"web": "http://dustindiaz.com"
		}],
		"repository": [{
			"type": "git",
	...
	"knockout.js": {
		...
		"version": "3.1.0",
		"description": "一个轻量级的MVVM框架，通过简易的UI绑定语法，实现动态更新UI",
		"homepage": "http://knockoutjs.com/",
		"keywords": ["MVVM", "声明性绑定", "UI自动更新", "依赖跟踪", "模板化"],
		"maintainers": [{
			"name": "SteveSanderson",
			"web": "https://github.com/SteveSanderson",
			"mail": "开发者邮箱未知"
		}],
		"repositories": [{
			"type": "git",
	...
	"laytpl.js": {
		...
		"filename": "laytpl.js",
		"version": "1.1",
		"description": "laytpl是一款颠覆性的JavaScript模板引擎，它用巧妙的实现方式，将自身的体积变得小巧玲珑，不仅性能接近极致，并且还具备传统js引擎的几乎所有功能。",
		"homepage": "http://sentsin.com/layui/laytpl/",
		"keywords": ["laytpl", "JavaScript模板引擎", "sentsin"],
		"maintainers": [{
			"name": "sentsin",
			"web": "http://sentsin.com/",
			"mail": "xu@sentsin.com"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/sentsin/laytpl.git"
		}]
	},
	"lightbox": {
		"name": "lightbox",
		...
		"maintainers": [{
			"name": "lokesh Dhakar",
			"web": "https://github.com/lokesh"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/lokesh/lightbox2"
		}]
	},
	"lithe": {
		"name": "lithe",
		...
		"homepage": "http://xiaojue.github.io/lithe",
		"keywords": ["javascript loader", "commonjs cmd loader"],
		"maintainers": [{
			"name": "xiaojue",
			"web": "http://tuer.me/user/profile/designsor"
		}],
		"repositories": [{
			"type": "git",
	...
	"lodash": {
		...
		"filename": "lodash.js",
		"version": "3.5.0",
		"description": "一个高效、模块化、可扩展的与underscore接口一致的实用工具库",
		"homepage": "https://lodash.com/",
		"keywords": ["utility", "performance"],
		"maintainers": [{
			"name": "John-David Dalton",
			"web": "http://allyoucanleet.com/",
			"mail": "john.david.dalton@gmail.com"
		}],
		"repositories": [{
			"type": "git",
	...
	"mindb": {
		...
		"homepage": "http://github.com/iwillwen/mindb",
		"keywords": ["html5", "database", "data modeling"],
		"maintainers": [{
			"name": "iwillwen",
			"web": "http://lifemap.in",
			"mail": "willwengunn@gmail.com"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/iwillwen/mindb"
		}]
	},
	"mobile-angular-ui": {
		"name": "mobile-angular-ui",
		"filename": "js/mobile-angular-ui.js",
		"version": "1.2.0",
		"description": "mobile angular ui.",
		"homepage": "http://mobileangularui.com",
		"keywords": ["mobile", "angular", "ui"],
		"maintainers": [{
			"name": "mcasimir"
		}],
		"repositories": [{
	...
	"muplayer": {
		...
		"version": "0.9.2",
		"description": "MuPlayer is an open source web audio player from Baidu Music, support HTML5 and Flash engine on different platforms.",
		"homepage": "http://labs.music.baidu.com/muplayer/doc/",
		"keywords": ["audio", "player", "baidu"],
		"maintainers": [{
			"name": "FE Team of Baidu Music"
		}],
		"repositories": [{
			"type": "git",
	...
	"nprogress": {
		...
		"keywords": ["progress bar", "UI"],
		"maintainers": [{
			"name": "Rico Sta. Cruz",
			"mail": "hi@ricostacruz.com"
		}],
		"version": "0.1.2",
		"repository": {
			"type": "git",
	...
	"oj": {
		...
		"keywords": ["templating", "html", "css", "js", "jquery", "backbone"],
		"author": "Evan Moran <evan@evanmoran.com>",
		"repository": {
			"type": "git",
			"url": "git://github.com/ojjs/oj.git"
		},
		"filename": "oj.min.js"
	},
	"opentip": {
		"name": "opentip",
		"filename": "opentip-jquery.min.js",
		"version": "2.0",
		"description": "漂亮的tooltips组件",
		"homepage": "http://www.opentip.org/",
		"keywords": ["opentip", "tooltips"],
		"maintainers": [{
			"name": "Matias Meno",
			"web": "https://github.com/enyo",
			"mail": "m@tias.me"
		...
		"repository": {
			"type": "git",
			"url": "https://github.com/enyo/opentip"
		}
	},
	"owl-carousel": {
		"name": "owl-carousel",
		...
		"keywords": ["carousel", "jquery", "slider"],
		"maintainers": [{
			"name": "Owl",
			"web": "https://github.com/OwlFonk"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/OwlFonk/OwlCarousel"
		}]
	},
	"oz.js": {
		"name": "oz.js",
	...
	"paper.js": {
		"name": "paper.js",
		"filename": "paper-full.min.js",
		"version": "0.9.18",
		"description": "The Swiss Army Knife of Vector Graphics Scripting",
		"homepage": "http://paperjs.org/",
		"keywords": ["vector", "graphic", "graphics", "2d", "geometry", "bezier", "curve", "curves", "path", "paths", "canvas", "svg", "paper", "paper.js"],
		"contributors": ["J�rg Lehni <juerg@scratchdisk.com> (http://scratchdisk.com)", "Jonathan Puckey <jonathan@studiomoniker.com> (http://studiomoniker.com)"],
		"repositories": [{
			"type": "git",
	...
	"piecon": {
		...
		"keywords": ["favicon", "piecon", "progress", "chart"],
		"maintainers": [{
			"name": "Lukas Lipka",
	...
	"pnotify": {
		...
		"keywords": ["pnotify", "notice", "notification", "growl", "nonblocking", "non-blocking", "unobtrusive", "bootstrap", "jquery"],
		"maintainers": [{
			"name": "SciActive"
		}],
		"repositories": [{
	...
	"prism": {
		...
		"keywords": ["prism", "prismjs", "prism.js", "highlight"],
		"author": {
			"name": "Lea Verou",
	...
	"pure": {
		...
		"repositories": [{
			"type": "git",
			"url": "https://github.com/yahoo/pure/"
		}],
		"licenses": [{
			"type": "BSD",
	...
	"qatrix": {
		...
		"repositories": [{
			"type": "git",
			"url": "https://github.com/qatrix/Qatrix"
		}]
	},
	"qtip2": {
		"name": "qtip2",
		...
		"keywords": ["tooltips", "qtip", "qtip2", "jQuery", "plugin"],
		"licenses": [{
			"type": "MIT",
	...
	"quint": {
		...
		"keywords": ["framework", "toolkit", "popular", "unit tests"],
		"maintainers": [{
	...
	"ractive.js": {
		...
		"keywords": ["DOM", "manipulation", "template", "data-binding"],
		"maintainers": [{
			"name": "Rich Harris",
	...
	"raphael": {
		...
		"keywords": ["vector", "graphics", "popular"],
		"maintainers": [{
	...
	"recorder.js": {
		...
		"homepage": "https://github.com/sofish/recorder.js",
		"keywords": ["html5", "capture"],
		"maintainers": [{
			"name": "Sofish Lin",
			"web": "http://sofish.de/"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/sofish/recorder.js"
		}]
	},
	"require.js": {
		"name": "require.js",
		...
		"keywords": ["loader", "modules", "asynchronous", "popular"],
		"maintainers": [{
			"name": "James Burke",
	...
	"respond.js": {
		...
		"keywords": ["polyfill", "queries", "responsive", "max-width", "min-width"],
		"maintainers": [{
			"name": "Scott Jehl",
	...
	"reqwest": {
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["reqwest.js", "reqwest.min.js"]
		}]
	},
	"restangular": {
		"name": "restangular",
	...
	"sammy.js": {
		...
		"keywords": ["framework", "restful", "popular", "jquery"],
		"maintainers": [{
			"name": "Aaron Quint"
		}],
		"repositories": [{
	...
	"reveal.js": {
		...
		"keywords": ["reveal.js", "reveal", "presentations", "slides"],
		"maintainers": [{
	...
	"sass.js": {
		"name": "sass.js",
		"filename": "sass.min.js",
		"version": "0.3.0",
		"description": "Sass parser in JavaScript",
		"homepage": "https://github.com/medialize/sass.js",
		"keywords": ["css", "css3"],
		"maintainers": [{
			"name": "Rodney Rehm",
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["dist/sass.worker.js", "dist/worker.js", "dist/sass.min.js", "dist/worker.min.js", "dist/sass.js"]
		}]
	},
	"scriptaculous": {
		"name": "scriptaculous",
	...
	"seajs": {
		...
		"keywords": ["loader", "module", "CMD", "browser"],
	...
	"select2": {
		...
		"keywords": ["select", "jquery", "dropdown", "ui"],
		"maintainers": [{
			"name": "Igor Vaynberg",
	...
	"selectize.js": {
		...
		"keywords": ["select", "jquery", "dropdown", "ui", "ajax"],
		"maintainers": [{
			"name": "Brian Reavis",
	...
	"sequence.js": {
		"name": "sequence.js",
		"filename": "jquery.sequence.js",
		"version": "1.0.1.1",
		"description": "The Responsive Slider with Advanced CSS3 Transitions",
		"homepage": "http://www.sequencejs.com/",
		"keywords": ["slider", "responsive"],
		"maintainers": [{
			"name": "Ian Lunn",
			"web": "https://github.com/IanLunn/Sequence"
		}],
		"repositories": [{
			"type": "git",
	...
	"shine.js": {
		...
		"homepage": "https://github.com/bigspaceship/shine.js",
		"repository": {
			"type": "git",
			"url": "git://github.com/bigspaceship/shine.js"
		},
		"keywords": ["shine", "shadows"],
		"licenses": [{
			"type": "MIT",
			"url": "https://github.com/bigspaceship/shine.js/blob/master/LICENSE"
		}]
	},
	"should.js": {
		"name": "should.js",
		"filename": "should.js",
		"version": "3.1.4",
		"description": "BDD风格的assertion库",
		"homepage": "https://github.com/visionmedia/should.js/",
		"keywords": ["should", "js"],
		"maintainers": [{
			"name": "visionmedia",
			"web": "https://github.com/visionmedia"
		}],
		"repositories": [{
			"type": "git",
	...
	"sigma.js": {
		...
		"keywords": ["sigma", "sigmajs", "sigma.js", "graph"],
		"maintainers": [{
			"name": "Alexis Jacomy",
			"web": "http://jcml.io",
			"mail": "alexis.jacomy@gmail.com"
		}],
		"repositories": [{
			"type": "git",
	...
	"simplestatemanager": {
		...
		"keywords": ["responsive", "states", "state"],
		"maintainers": [{
			"name": "Jonathan Fielding",
			"email": "j.fielding@me.com",
			"web": "http://www.jonathanfielding.com"
		}],
		"repositories": [{
			"type": "git",
	...
	"simplemodal": {
		"name": "simplemodal",
		"filename": "jquery.simplemodal.min.js",
		"version": "1.4.4",
		"description": "SimpleModal is a lightweight jQuery Plugin which provides a powerful interface for modal dialog development.",
		"homepage": "http://www.ericmmartin.com/projects/simplemodal/"
	},
	"skrollr": {
		"name": "skrollr",
		"filename": "skrollr.min.js",
		"version": "0.6.24",
		...
		"keywords": ["skrollr", "standalone", "scrolling", "parallax", "mobile"],
		"author": {
	...
	"slidesjs": {
		...
		"keywords": ["slides", "navigation", "pagination", "play", "effect", "callback"],
	...
	"socket.io": {
		...
		"keywords": ["websockets", "node", "popular"],
		"maintainers": [{
			"name": "LearnBoost"
		}],
		"repositories": [{
	...
	"svg.js": {
		...
		"filename": "svg.min.js",
		"version": "1.0rc3",
		"description": "A lightweight JavaScript library for manipulating and animating svg using an uncluttered syntax.",
		"homepage": "http://svgjs.com/",
		"keywords": ["vector", "graphics", "lightweight"],
		"maintainers": [{
			"name": "Wout Fierens",
	...
	"swipe": {
		...
		"keywords": ["swipe", "touch", "mobile", "slider"],
		"maintainers": [{
			"name": "Brad Birdsall",
	...
	"syntaxhighlighter": {
		...
		"keywords": ["highlight", "highlighter"],
		"maintainers": [{
	...
	"tagmanager": {
		...
		"keywords": ["tags", "manager", "input", "form"],
		...
		"files": ["README.md", "tagmanager.css", "tagmanager.js", "license.txt"]
	},
	"term.js": {
		"name": "term.js",
		"filename": "term.js",
		"version": "0.0.2",
		"description": "A full xterm clone written in javascript.",
		"homepage": "https://github.com/chjj/term.js",
		"keywords": ["term"],
		"maintainers": [{
			"name": "Christopher Jeffrey",
			"web": "https://github.com/chjj/term.js"
		}],
		"repositories": [{
			"type": "git",
	...
	"timelinejs": {
		"name": "timelinejs",
		"filename": "js/storyjs-embed.js",
		"version": "2.32.0",
		"description": "TimelineJS is an open-source tool that enables you to build visually-rich interactive timelines and is available in 40 languages.",
	...
	"puerh": {
		...
		"filename": "puerh.css",
		"version": "2.0",
		"description": "Puerh，百姓网 UI 库的开源版本。旨在建立稳定、简洁、兼容的前端框架。兼容 Mac/Windows 下的 IE6+ / Firefox / Google Chrome 浏览器。 Puerh 的目标是构建一套适合百姓网的前端解决方案，从模块区分上，她包含：Typography、Grid、Font Icon3、UI 组件 和 JS 组件",
		"homepage": "https://github.com/baixing/Puerh",
		"keywords": ["Puerh", "UI", "Bootstrap", "baixing"],
		"maintainers": [{
			"name": "Sofish Lin",
			"web": "http://sofish.de/"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/baixing/Puerh"
		}]
	},
	"todc-bootstrap": {
		"name": "todc-bootstrap",
		"filename": "todc-bootstrap.min.css",
		"version": "3.1.1-3.2.1",
		"description": "Google-styled theme for Bootstrap.",
		"homepage": "http://todc.github.com/todc-bootstrap",
		"keywords": ["todc", "bootstrap", "google"],
		"maintainers": [{
			"name": "Tim O'Donnell",
			"web": "https://github.com/todc"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/todc/todc-bootstrap"
		}]
	},
	"trianglify": {
		"name": "trianglify",
		"filename": "trianglify.min.js",
		"version": "0.1.2",
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["trianglify.js", "trianglify.min.js"]
		}],
		"files": ["angular-image-spinner.min.js"],
		"homepage": "https://github.com/qrohlf/trianglify",
		"author": {
			"name": "Quinn Rohlf <qr@qrohlf.com>"
		},
		"repository": {
			"type": "git",
	...
	"typeahead.js": {
		...
		"keywords": ["twitter", "typeahead", "autocomplete"],
		"maintainers": [{
			"name": "Twitter, Inc."
		}],
		"repositories": [{
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["dist/bloodhound.js", "dist/bloodhound.min.js", "dist/typeahead.bundle.min.js", "dist/typeahead.jquery.js", "dist/typeahead.jquery.min.js", "dist/typeahead.bundle.js"]
		}]
	},
	"uikit": {
		"name": "uikit",
	...
	"typo.css": {
		...
		"repositories": [{
			"type": "git",
			"url": "https://github.com/sofish/typo.css"
		}]
	},
	"underscore.js": {
		"name": "underscore.js",
	...
	"unveil": {
		...
		"bugs": "https://github.com/luis-almeida/unveil/issues",
		"licenses": [{
			"type": "MIT",
			"url": "http://opensource.org/licenses/MIT"
		}]
	...
	"uri.js": {
		...
		"keywords": ["uri", "urijs", "uri.js", "url", "uri mutation", "url mutation", "uri manipulation", "url manipulation", "uri template", "url template", "unified resource locator", "unified resource identifier", "query string", "RFC 3986", "RFC3986", "RFC 6570", "RFC6570"],
		"maintainers": [{
			"name": "Rodney Rehm",
	...
	"validator": {
		...
		"version": "1.0",
		"description": "一个简单、轻量级，但功能强大的 Validator 组件，兼容 IE6+，兼容 HTML5 语法",
		"homepage": "https://github.com/sofish/validator.js",
		"keywords": ["validator", "jquery"],
		"maintainers": [{
			"name": "Sofish Lin",
			"web": "http://sofish.de/"
		}],
		"repositories": [{
			"type": "git",
			"url": "https://github.com/sofish/validator.js"
		}]
	},
	"validform": {
		"name": "validform",
		...
		"homepage": "http://validform.rjboy.cn/",
		"keywords": ["validform", "jquery"],
		"maintainers": [{
			"name": "sean",
			"web": "http://www.rjboy.cn/"
		}],
		"repositories": [{
			"type": "http",
	...
	"visibility.js": {
		...
		"keywords": ["polyfill", "html5", "visibility"],
		"maintainers": [{
			"name": "Andrey Sitnik",
	...
	"yui": {
		...
		"keywords": ["yui", "yahoo", "ui", "library", "framework", "toolkit", "popular"],
		"maintainers": [{
			"name": "Yahoo! Inc."
		}],
		"repositories": [{
	...
	"accounting.js": {
		...
		"keywords": ["accounting", "number", "money", "currency"],
		"maintainers": [{
			"name": "josscrowcroft"
		}],
		"repositories": [{
		...
		"npmFileMap": [{
			"basePath": "/",
			"files": ["accounting.min.js", "accounting.js"]
		}]
	}
}
